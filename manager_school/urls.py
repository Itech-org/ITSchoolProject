...
urlpatterns = [
    ...
    path('registration_user/unique/', register_user_unique, name='registration_user'),
    ...
    path('group/<str:slug>/settings/', group_settings, name='group_settings'),
    ...
    path('contracts/create/<int:lead_id>/<int:student_id>/', create_contract_page, name='create_contract_page'),
